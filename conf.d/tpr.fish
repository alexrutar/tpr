...
function __tpr_uninstall --on-event tpr_uninstall
    ...
    functions --erase \
        ...
        __tpr_compile __tpr_compile_force __tpr_tar __tpr_populate_tempdir __tpr_populate_index \
        __tpr_list_templates __tpr_require __tpr_config_get __tpr_with_tempdir \
        __tpr_publish __tpr_archive __tpr_diff __tpr_build __tpr_snap
